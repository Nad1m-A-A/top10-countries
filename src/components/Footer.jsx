    ...
    <footer>
        <div className='footer__container'>
            ...
            <div className='footer__div'>
                <h3>Developed by NADIM-A-A.</h3>
                <a className='site-link' href='https://github.com/jsx-eslint/eslint-plugin-jsx-a11y/blob/HEAD/docs/rules/anchor-is-valid.md' target='_blank' rel="noreferrer">visit site</a>
                <span>&copy; all rights reserves</span> 
                </div>

            <div className='footer__div borders'>
                <h3>Know More About Each Aspect:</h3>
                <ul>
            ...
            <div className='footer__div '>
                ...
                <ul>
                    ...
                    <li>Simphony: <a href='https://www.pexels.com/photo/antique-antique-globe-antique-shop-antique-store-414916/' target='_blank' rel="noreferrer">Vivaldi</a> </li>
                    <li>API: <a href='https://restcountries.com/v3.1/all' target='_blank' rel="noreferrer">Rest Countries</a> </li>
                </ul>
            </div>
