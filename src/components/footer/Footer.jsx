    ...
    <footer>
        <div className='footer__container'>
            ...
            <div className='footer__div'>
                ...
                <a className='site-link' href='https://github.com/Nad1m-A-A?tab=overview&from=2022-09-01&to=2022-09-30' target='_blank' rel="noreferrer">visit site</a>
            ...
            <div className='footer__div '>
                ...
                <ul>
                    ...
                    <li>Simphony: <a href='https://www.youtube.com/watch?v=SY3Kxf7ZTeI' target='_blank' rel="noreferrer">Vivaldi</a> </li>
